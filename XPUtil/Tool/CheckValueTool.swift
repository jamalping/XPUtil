...
public struct CheckValueTool {
    /// 是否是有效的手机号
    static func isValidatePhoneNumber(_ phoneNumber: String) -> Bool {
    ...
    /// 是否是有效的身份证
    static func isValidateIDCard(_ idCard: String) -> Bool {
    ...
    /// 是否是有效的港澳通行证
    static func isValidateHongkong(_ hkNumber: String) -> Bool {
    ...
    /// 是否是有效的港澳通行证
    static func isValidateMacao(_ mcNumber: String) -> Bool {
    ...
    /// 台湾
    static func isValidateTaiwan(_ twNumber: String) -> Bool {
    ...
    /// 护照
    static func isValidatePassport(_ passport: String) -> Bool {
    ...
    /// 是否是有效的车牌号
    static func isValidateCarNo(_ CarNo: String) -> Bool {
    ...
    ///   - regeXStr: 正则表达式
    /// - Returns: 是否有效
    static func isValueData(string: String,regeXType: regeXStringType) -> Bool {
        return self.isValueData(string: string, predicateString: regeXType.rawValue)
    }
    
    static func isValueData(string: String,predicateString: String) -> Bool {
